package com.github.szil.jasperreport;
...
import com.github.szil.JasperCompilerMojo;
 ...
 */
public class JasperCompilerTest extends AbstractMojoTestCase {
	...
	private void getAndExecuteMojo(String pluginPom) throws Exception {
		JasperCompilerMojo mojo = (JasperCompilerMojo) lookupMojo("jasper", pluginPom);
		assertNotNull(mojo);
		mojo.execute();
	}
	...
	public void testInvalidFilesStopBuild() throws Exception {
		...
		try {
			...
			assertEquals(JasperCompilerMojo.COMPILER_ERROR_MSG, e.getMessage());
		}
	}
